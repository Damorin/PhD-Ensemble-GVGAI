package agents.edsAgents.Concurrent_SingleAction_EDS.voices.olets;
...
public class Agent extends AbstractHeuristicPlayer implements Voice {
    ...
    public Opinion askOpinion() {
        return new Opinion(this.act(stateObs, elapsedCpuTimer), mctsPlayer.value, getHeuristicName());
    }
