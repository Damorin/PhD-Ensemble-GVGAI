package agents.edsAgents.EDS_R_OLETSMCTS.voices.search.pessimisticMCTS;

import agents.edsAgents.EDS_R_OLETSMCTS.voices.Opinion;
import agents.edsAgents.EDS_R_OLETSMCTS.voices.Voice;
 ...
 */
public class PessimisticMCTSVoice implements Voice {
     ...
     */
    public PessimisticMCTSVoice(StateObservation so, ElapsedCpuTimer elapsedTimer)
    {
