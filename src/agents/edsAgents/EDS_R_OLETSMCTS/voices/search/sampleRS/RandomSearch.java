package agents.edsAgents.EDS_R_OLETSMCTS.voices.search.sampleRS;
...
public class RandomSearch implements Voice {
     ...
     */
    public RandomSearch(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
