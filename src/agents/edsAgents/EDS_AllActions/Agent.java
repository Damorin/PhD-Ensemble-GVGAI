...
//        decisionSystem.addVoice(new agents.edsAgents.EDS_AllActions.voices.Yolobot.Agent(stateObs, elapsedCpuTimer));
        decisionSystem.addVoice(new agents.edsAgents.EDS_AllActions.voices.olets.usingHeuristics.Agent(stateObs, elapsedCpuTimer, "COGPaper.heuristics.MaximizeScoreHeuristic"));
        decisionSystem.addVoice(new agents.edsAgents.EDS_AllActions.voices.olets.usingHeuristics.Agent(stateObs, elapsedCpuTimer, "COGPaper.heuristics.MaximizeExplorationHeuristic"));
