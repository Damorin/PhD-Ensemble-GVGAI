package agents.competitorAgents.YBCriber.pcollections;
...
////entrySet().iterator() IMPLEMENTATION ////	
  ...
  private static final class EntryIterator<V> implements Iterator<Entry<Integer,V>> {
    ...
    public Entry<Integer,V> next() {
      ...
      final Entry<Integer,V> result = new agents.competitorAgents.YBCriber.pcollections.SimpleImmutableEntry<Integer,V>(key, node.value);
