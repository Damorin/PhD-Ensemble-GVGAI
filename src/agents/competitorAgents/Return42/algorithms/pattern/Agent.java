package agents.competitorAgents.Return42.algorithms.pattern;

import agents.competitorAgents.Return42.GameStateCache;
import agents.competitorAgents.Return42.heuristics.patterns.EnemyPattern;
import agents.competitorAgents.Return42.heuristics.patterns.Pattern;
...
public class Agent extends AbstractPlayer {
    ...
    public Agent(StateObservation so, ElapsedCpuTimer elapsedTimer) {
        ...
        fallback = new agents.competitorAgents.Return42.algorithms.GA.Agent(so, elapsedTimer);
    }
