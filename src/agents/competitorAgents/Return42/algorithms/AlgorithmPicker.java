package agents.competitorAgents.Return42.algorithms;

import tools.ElapsedCpuTimer;
import agents.competitorAgents.Return42.algorithms.deterministic.CombinedDeterministicAgent;
import agents.competitorAgents.Return42.algorithms.deterministic.NonDeterministicRandomAgent;
...
public class AlgorithmPicker {
    ...
    public AbstractPlayer pickAlgorithm( KnowledgeBase knowledge, StateObservation state, ElapsedCpuTimer timer ) {
        ...
        if (classification.isDeterministic() && classification.hasSelfMovingObjects() ) {
            ...
            return new agents.competitorAgents.Return42.algorithms.pattern.Agent(state, timer);
