...
public class Agent extends AbstractPlayer {
    ...
    public Agent(StateObservation stateObs, ElapsedCpuTimer elapsedCpuTimer) {
        decisionSystem.addVoice(new Concurrent_All_Actions_EDS.voices.olets.usingHeuristics.Agent(stateObs, elapsedCpuTimer, "COGPaper.heuristics.MaximizeScoreHeuristic"));
        decisionSystem.addVoice(new Concurrent_All_Actions_EDS.voices.olets.usingHeuristics.Agent(stateObs, elapsedCpuTimer, "COGPaper.heuristics.MaximizeExplorationHeuristic"));
