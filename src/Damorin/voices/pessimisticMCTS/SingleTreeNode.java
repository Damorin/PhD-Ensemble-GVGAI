package Damorin.voices.pessimisticMCTS;

import Damorin.heuristics.StateHeuristic;
...
//        System.out.println("-- " + numIters + " -- ( " + avgTimeTaken + ")");
    ...
    public double value(StateObservation a_gameState) {
        return heuristic.endHeuristicAccumulation(a_gameState);
    }
    ...
    public List<Opinion> mostVisitedAction() {

        List<Opinion> opinions = new ArrayList<>();
        for (SingleTreeNode tn : children) {
            if (tn != null) {
                opinions.add(new Opinion(actions[tn.childIdx], tn.totValue));
            }
        }
        return opinions;
    }
